...
def main():
    ...
    # Стили для вкладок (сделаем значительно крупнее)
    st.markdown("""
    <style>
    ...
    tab1, tab2, tab3 = st.tabs(["📁 Файлы", "⚙️ Параметры", "▶️ Выполнение"])
    ...
    with tab2:
        ...
        model_size = st.selectbox("Размер модели:", 
                                  ...
                                  index=4)  # По умолчанию large-v3
        
        # Параметры для левого и правого каналов в двух колонках
        st.subheader("🎛️ Настройка параметров каналов")
